...
public class EE11AppEngineAuthentication {
  ...
  public static ConstraintSecurityHandler newSecurityHandler() {
    ConstraintSecurityHandler handler =
  ...
  /**
   * {@code AppEngineAuthenticator} is a custom {@link LoginAuthenticator} that knows how to
   * redirect the current request to a login URL in order to authenticate the user.
   */
